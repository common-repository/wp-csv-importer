...
<div class="wrap">
	...
	<div id="wpimporter-tab-menu"><a id="wpimporter-general" class="wpimporter-tab-links active" >General</a> <a  id="wpimporter-support" class="wpimporter-tab-links">Our other plugins</a> </div>
	...
	<h2>General Settings</h2>
		   <?php wp_nonce_field( 'wpcsv_import_csv_action', 'wpcsv_csv_nonce_field' ); ?>
		<!-- Parent category -->
...
<?php
    ...
    function post($options) {
        ...
        if ( ! isset( $_POST['wpcsv_csv_nonce_field'] ) || ! wp_verify_nonce( $_POST['wpcsv_csv_nonce_field'], 'wpcsv_import_csv_action' ) ) {
...
function wp_csv_importer_add_settings_link( $links ) {
  $settings_link = '<a href="tools.php?page=wp-csv-importer">' . __( 'Settings', 'wp-csv-importer' ) . '</a>';
